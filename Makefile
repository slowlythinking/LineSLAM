LineDetectAndMatch : LineDetectAndMatch.o LineSLAMSystem.o LineTracking.o Drawer.o Viewer.o
	g++ LineDetectAndMatch.o LineSLAMSystem.o LineTracking.o Drawer.o Viewer.o -o LineDetectAndMatch EDLinesLib.a `pkg-config --cflags --libs opencv`
...
#RealLineSLAM : RealLineSLAM.o LineSLAMSystem.o LineDetector.o LineTracking.o Drawer.o Viewer.o
#	g++ RealLineSLAM.o LineSLAMSystem.o LineDetector.o LineTracking.o Drawer.o Viewer.o -o RealLineSLAM EDLinesLib.a `pkg-config --cflags --libs opencv`
#RealLineSLAM.o : RealLineSLAM.cpp LineSLAMSystem.h LS.h
#	g++ -c RealLineSLAM.cpp LineSLAMSystem.h LS.h -std=c++11
